...
public class TeacherRegisterPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnRegis.setOnClickListener(v -> {
            ...
            String type = "reg";
            RetrofitInstance.getInstance().getRetrofit().register(user, pass, email, fname, lname, "1").enqueue(new Callback<ResponseBody>() {

                @Override
                public void onResponse(@NotNull Call<ResponseBody> call, @NotNull Response<ResponseBody> response) {
                    Log.d("TEST", "TEST");
                    Intent intent = new Intent(TeacherRegisterPage.this, MainActivity.class);
